...
const Card =(props)=>{
    ...
    props.type ==="person"?(
        ...
        <img src={`https://starwars-visualguide.com/assets/img/characters/${props.index }.jpg`}
        onError={(e)=>{
 ...
 props.type ==="vehicle"?(
    ...
    props.type ==="planet"?(
      field = <div className="card" style={{"width": "18rem;"}}>
      <img src={`https://starwars-visualguide.com/assets/img/planets/${props.index }.jpg`}
      onError={(e)=>{
          e.target.src='https://starwars-visualguide.com/assets/img/placeholder.jpg'
      }}
      className="card-img-top" />
  ...
  props.type ==="starship"?(
    field = <div className="card" style={{"width": "18rem;"}}>
    <img src={`https://starwars-visualguide.com/assets/img/starships/${props.index}.jpg`}
    onError={(e)=>{
        e.target.src='https://starwars-visualguide.com/assets/img/placeholder.jpg'
    }}
    className="card-img-top"/>
